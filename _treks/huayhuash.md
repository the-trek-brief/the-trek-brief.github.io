...
## Getting there
First, get to **Lima**. From Lima, several bus companies run to **Huaraz**. The journey takes roughly **7–9 hours**. Morning departures are available, as well as overnight buses.
Bus companies usually use their own terminals, so your departure point depends on the company you choose. For example, **Cruz del Sur** departs from its Javier Prado terminal in central Lima.

Depending on your arrival time and plans, you have two practical options:
- Go into central Lima, stay there overnight, then take a bus to Huaraz the next day.
- If the timing works with your flight, go directly from the airport area to [Plaza Norte](https://maps.app.goo.gl/uRG5Ta6X7QANJVta7), where buses to Huaraz stop. Plaza Norte is much closer to the airport than central Lima.
...
- **Laguna Llaca** or **Laguna Parón** for easier acclimatization days.

There is public transport from Huaraz to the Huayhuash trailheads - Huaraz to Chiquián then Quartelhuain but it's not convenient . Ask local travel agencies if they can sell you a ride with one of their groups or can arrange a private ride, usually around **300–350 PEN** per car.&#x20;
...
Exact coordinates are [exact viewpoint is here](https://maps.app.goo.gl/acp1gPfqSRgcjSD7A)
